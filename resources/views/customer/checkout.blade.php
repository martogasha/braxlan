                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <div class="radio-option paypal">
                                                        ...
                                                        <label for="payment-3">PayPal<span class="image"><img src="assets/images/paypal.html" alt=""></span></label>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="text-right"><a href="{{url('success')}}" class="btn-normal btn">Place Order</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
