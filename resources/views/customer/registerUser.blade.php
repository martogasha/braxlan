        ...
        <div class="row">
            <div class="col-lg-4 offset-lg-4">
                <div class="theme-card">
                    ...
                    <form class="theme-form" action="{{route('registerCustomOne')}}" method="post" id="registerForm">
                        @csrf
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="col-md-12 ">
                                <p >Have you already account? <a href="{{url('loginUser')}}" class="txt-default">click</a> here to &nbsp;<a href="{{url('login')}}" class="txt-default">Login</a></p>
                            </div>
                        </div>
                    </form>
                </div>
