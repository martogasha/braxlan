                            ...
                            <div class="col-sm-12">
                                <div class="collection-product-wrapper">
                                    ...
                                    <div class="product-wrapper-grid">
                                        <div class="row">
                                            @foreach($teqs as $teq)
                                                <a href="{{url('productDetail',$teq->id)}}">
                                                    <div class="col-xl-3 col-md-4 col-6  col-grid-box">
                                                        <div class="product">
                                                            <div class="product-box">
                                                                <div class="product-imgbox">
                                                                    <div class="product-front">
                                                                        <img src="{{asset('uploads/product/'.$teq->product_image)}}" class="img-fluid  " alt="product">
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="icon-detail">
                                                                        <div class="icon-detail">
                                                                            <form action="{{route('cart.store')}}" method="post">
                                                                                @csrf
                                                                                <input type="hidden" name="productId" value="{{$teq->id}}">
                                                                                <button type="submit">
